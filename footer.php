...
<footer class="container-fluid bg-footer py-5">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-12 col-sm-6 offset-sm-3 col-md-4 offset-md-4 col-lg-4 offset-lg-0 col-xl-4 offset-xl-0 px-5 pb-5 text-center"><img class="logo-footer-size" src="<?php echo get_template_directory_uri(); ?>/assets/logo.png" alt="logo de la promotion des gitBreakers" /></div>
