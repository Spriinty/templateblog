...
<head>
    ...
    <meta name="description"
        content="Bienvenue sur le blog de la promo 33 de l'Access Code School. Découvrez notre univers à travers nos articles et projets réalisés au cours de ces derniers mois.">
...
<body>
    ...
    <header class="container-fluid bg-dark text-white">
        <h1>
            Bienvenue sur le blog de la promo
        </h1>
    </header>
    <!-- FIN BLOC HEADER -->
